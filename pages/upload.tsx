                  ...
                  <label className="cursor-pointer ">
                    <div className="flex flex-col items-center justify-center h-full">
                      ...
                      <p className="text-gray-400 text-center mt-10 text-sm leading-10">
                        MP4 or WebM or ogg <br /> 720x1280 or higer <br /> Up to
                        10 minutes <br /> Less then 2GB
                      </p>
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          >
            {topics.map((t) => (
              <option
                key={t.name}
                className="outline-none capitalize bg-white text-gray-700 text-md p-2 hove:bg-slate-300"
                value={t.name}
              >
                {t.name}
              </option>
